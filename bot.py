...
async def start(msg: types.Message):
    ...
    if await is_verified(uid):
        await msg.answer(
            "💙 Welcome back to Marscot Shop Panel\n\n"
            "🛍 Premium digital store for iOS, Android & PC tools.\n"
            "⚡ Fast delivery system with secure payments.\n"
            "🎰 Try Lucky Spin for bonus rewards.\n"
            "💰 Check balance & manage orders anytime.\n\n"
    ...
    # ❌ NOT VERIFIED
    await msg.answer(
        "💙 Welcome to Marscot Premium Shop Panel\n\n"
        "🛍 A secure digital store for premium tools & services.\n\n"
        "✨ Features:\n"
        "• Instant shop system\n"
        "• UPI & Binance payments\n"
        "• Lucky Spin rewards 🎰\n"
        "• 24/7 support system\n\n"
